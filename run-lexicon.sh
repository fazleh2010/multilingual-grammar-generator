...
java -jar target/QuestionGrammarGenerator.jar conf/inputConf_lexicon_7_en.json dataset/dbpedia_en.json
java -jar target/QuestionGrammarGenerator.jar conf/inputConf_lexicon_8_en.json dataset/dbpedia_en.json
