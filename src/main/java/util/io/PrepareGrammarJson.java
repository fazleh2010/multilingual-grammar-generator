...
public class PrepareGrammarJson {
    ...
    public static void main(String[] args) throws IOException {
        String propertyDir = "/home/elahi/A-Grammar/journal/multilingual-grammar-generator/result/de/";
        File file = new File(propertyDir + "grammar_FULL_DATASET_DE.json");
        List<File> protoSimpleQFiles = new ArrayList<File>();
        protoSimpleQFiles.add(file);
        String outputFileName = "grammar_" + Language.DE + ".json";
