...
public class SentenceTemplateFactoryEN implements Factory<SentenceTemplateRepository>, TempConstants {
    ...
    private void initEN(Language language) {
        ...
        sentenceTemplateRepository.add(
                createSentenceTemplate(language,
                        List.of( //"Hatte Che Guevara Kinder?",
        ...
        sentenceTemplateRepository.add(createSentenceTemplate(language,
                ...
                InTransitivePPFrame,
                HOW_MANY_THING_BACKWARD + "_" + WHAT_WHICH_PRESENT_THING_1 + backward
        )
        );
        ...
        ///////////////////////////////
        sentenceTemplateRepository.add(createSentenceTemplate(language,
                List.of( //"Welche Profisurfer wurden auf den Philippinen geboren?",
        ...
        //Wer ist 2010 geboren?
        sentenceTemplateRepository.add(createSentenceTemplate(language,
                List.of( //Wo wurde Donald Trump geboren?
    ...
    public static Map<String, String> getGroupsEN(String frame) {
        ...
        if (frame.contains(FrameType.NPP.getName())) {
            ...
            group.put(HOW_MANY_THING_BACKWARD + "_" + WHAT_WHICH_PRESENT_THING_1 + forward, subject + "-" + "type" + "2");
            group.put(HOW_MANY_THING_BACKWARD + "_" + WHAT_WHICH_PRESENT_THING_1 + backward, object + "-" + "type" + "2");
            group.put(WHAT_WHICH_LOCATION + forward, subject + "-" + "type" + "3");
            group.put(WHAT_WHICH_LOCATION + backward, object + "-" + "type" + "3");
            group.put(WHAT_WHICH_PRESENT_THING_2 + forward, subject + "-" + "type" + "4");
            group.put(WHAT_WHICH_PRESENT_THING_2 + backward, object + "-" + "type" + "4");
            group.put(WHEN_WHAT_PAST_THING + forward, subject + "-" + "type" + "5");
            group.put(WHEN_WHAT_PAST_THING + backward, object + "-" + "type" + "5");
            group.put(WHEN_WHO_PAST_PERSON + forward, subject + "-" + "type" + "6");
            group.put(WHEN_WHO_PAST_PERSON + backward, object + "-" + "type" + "6");
            group.put(WHERE_WHO_PAST_PERSON + forward, subject + "-" + "type" + "7");
            group.put(WHERE_WHO_PAST_PERSON + backward, object + "-" + "type" + "7");
            group.put(WHERE_WHAT_PRESENT_THING + forward, subject + "-" + "type" + "8");
            group.put(WHERE_WHAT_PRESENT_THING + backward, object + "-" + "type" + "8");
            group.put(PERSON_CAUSE + forward, subject + "-" + "type" + "9");
            group.put(PERSON_CAUSE + backward, object + "-" + "type" + "9");
            group.put(HOW_MANY_THING + forward, subject + "-" + "type" + "10");
            group.put(HOW_MANY_THING + backward, object + "-" + "type" + "10");
            group.put(HOW_MANY_TOTAL + forward, subject + "-" + "type" + "11");
            group.put(HOW_MANY_TOTAL + backward, object + "-" + "type" + "11");
