...
public class SentenceTemplateFactoryIT implements Factory<SentenceTemplateRepository>, TempConstants {
    ...
    private void init(Language language) {
        ...
        sentenceTemplateRepository.add(
                createSentenceTemplate(language,
                        List.of( //Wo ist der Westminster-Palast?",
      ...
      createSentenceTemplate(language,
        ...
        sentenceTemplateRepository.add(
                createSentenceTemplate(language,
                        List.of( //In quale città si trova il quartier generale delle Nazioni Unite?
                                /* //Was fließt durch...?
        "interrogativePronoun(nominativeCase:domain:singular) verb(mainVerb:present:thridPerson) preposition adjunct(range)?",
         //Welcher Fluss fließt durch...?
        "interrogativeDeterminer(nominativeCase:domain:singular) verb(mainVerb:present3rd:thridPerson) preposition adjunct(range)?",
        ...
        sentenceTemplateRepository.add(
                createSentenceTemplate(language,
                        List.of( /*//Was wurde 2010 fertiggestellt?
        ...
        sentenceTemplateRepository.add(
                createSentenceTemplate(language,
                        List.of( //"interrogativeDeterminer(nominativeCase:domain:singular) verb(component_werden:past:singular) adjunct(range) verb(mainVerb:perfect:thridPerson)?",
        ...
        sentenceTemplateRepository.add(
                createSentenceTemplate(language,
                        List.of( //"Wer ist an Malaria gestorben?
                                //"interrogativePronoun(nominativeCase:domain:singular) verb(component_be:present:singular) preposition adjunct(range) verb(mainVerb:perfect:thridPerson)?",
    ...
    public static Map<String, String> getGroupsIT(String frame) {
        ...
        if (frame.contains(FrameType.NPP.getName())) {
            ...
            group.put(HOW_MANY_THING + activeTransitive, subject + "-" + "type" + "4");
            group.put(HOW_MANY_TOTAL + passiveTransitive, object + "-" + "type" + "4");
            ...
            group.put(HOW_MANY_THING + forward, subject + "-" + "type" + "11");
            group.put(HOW_MANY_THING + backward, object + "-" + "type" + "11");
