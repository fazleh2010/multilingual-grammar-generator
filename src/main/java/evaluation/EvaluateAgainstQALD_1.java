...
public class EvaluateAgainstQALD_1 {

    private static final Logger LOG = LogManager.getLogger(EvaluateAgainstQALD_1.class);
    ...
    public EvaluateAgainstQALD_1(String language,String endpoint) {
